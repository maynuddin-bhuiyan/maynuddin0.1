...
<nav className="navbar navbar-expand-lg navbar-light" id={styles.Navbar}>
  ...
  <div className={`collapse navbar-collapse justify-content-between ${styles.NavbarMenu}`} id="navbarToggleExternalContent">
  <a className="navbar-brand" href="#">
    ...
    <ul className={`navbar-nav mr-auto ${styles.Menu}`}>
      ...
      <button className={styles.NavbarBtn}> 
        <a href="https://drive.google.com/file/d/1_KIuP5xv7mjAucMsF99gi8nivWlUJVsS/view?usp=sharing" target="_blank" rel="noreferrer">Resume</a>
      </button>
